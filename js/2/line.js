...
!function(){
	...
	function l(){
		...
		return{
			l:w,z:o(v,"zIndex",-1),o:o(v,"opacity",0.65),c:o(v,"color","0,0,0"),n:o(v,"count",141)
		}
	}
	function k(){
	...
	function b(){
		e.clearRect(0,0,r,n);var w=[f].concat(t);var x,v,A,B,z,y;t.forEach(function(i){
			...
			for(v=0;v<w.length;v++){
				...
				};u.id="lines";u.style.cssText="position:fixed;top:0;left:0;z-index:"+s.z+";opacity:"+s.o;j("body")[0].appendChild(u);k(),window.onresize=k;window.onmousemove=function(i){i=i||window.event,f.x=i.clientX,f.y=i.clientY},window.onmouseout=function(){
					f.x=null,f.y=null
				};
